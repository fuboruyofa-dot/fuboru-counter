...
function renderSidebar(activeId, userRole) {
  ...
  <aside class="sidebar" id="appSidebar">
    ...
    <nav class="sidebar-nav">
      <a class="nav-item ${activeId==='index'?'active':''}" href="/index.html" data-label="Live Counter">
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
        <span class="nav-label">Live Counter</span>
      </a>
      <a class="nav-item ${activeId==='analytics'?'active':''}" href="/analytics.html" data-label="Analytics">
      ...
      <a class="nav-item ${activeId==='history'?'active':''}" href="/history.html" data-label="History Log">
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
        <span class="nav-label">History Log</span>
      </a>
      <div class="nav-section" style="${adminStyle}">Admin</div>
      <a class="nav-item ${activeId==='operators'?'active':''}" href="/operators.html" data-label="Operator & RFID" style="${adminStyle}">
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
        <span class="nav-label">Operator & RFID</span>
      </a>
      <a class="nav-item ${activeId==='products'?'active':''}" href="/products.html" data-label="Produk & Target" style="${adminStyle}">
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>
        <span class="nav-label">Produk & Target</span>
      </a>
      <a class="nav-item ${activeId==='machines'?'active':''}" href="/machines-admin.html" data-label="Kelola Mesin" style="${adminStyle}">
        ...
        <span class="nav-label">Kelola Mesin</span>
      </a>
    </nav>
